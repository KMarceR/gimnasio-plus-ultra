<template>
  <div class="relative" ref="dropdownRef">
    ...
    <button
      ...
      type="button"
    >
      <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-brand-50 text-sm font-semibold text-brand-600 ltr:mr-3 rtl:ml-3">
        {{ currentUser?.initials || 'PU' }}
      </span>

      <span class="block font-medium text-theme-sm ltr:mr-1 rtl:ml-1">{{ currentUser?.name || 'Plus Ultra' }}</span>
