...
import "./chunk-NMFWHO23.js";
import "./chunk-PZ5AY32C.js";

// node_modules/@fullcalendar/vue3/chunks/3bf85f9c.js
...
// node_modules/@fullcalendar/vue3/chunks/93e28f45.js
  ...
  getMirrorEl() {
    ...
    if (!mirrorEl) {
      ...
      applyStyle(mirrorEl, {
        ...
        zIndex: this.zIndex,
        visibility: "",
        // in case original element was hidden by the drag effect
...
function joinHitsIntoSelection(hit0, hit1, dateSelectionTransformers) {
  ...
  entries.sort(hasInstants ? (entry0, entry1) => compareNumbers(entry0.ms, entry1.ms) : (entry0, entry1) => compareNumbers(entry0.date.valueOf(), entry1.date.valueOf()));
  let props = {};
...
function computeHitDelta(hit0, hit1, options = {}) {
  ...
  return {
    delta: instantDeltaMs != null ? createDuration(instantDeltaMs) : diffDates(date0, date1, hit0.context.dateEnv, options.largeUnit),
    instantDeltaMs
  };
}
var EventDragging = class _EventDragging extends Interaction {
  constructor(settings) {
    ...
    this.handlePointerDown = (ev) => {
      ...
      mirror.colorScheme = options2.colorScheme || "";
      let isValid = component2.isValidSegDownEl(origTarget) && !origTarget.closest(`.${classNames.internalEventResizer}`);
      if (!isValid) {
        dragging2.cancel();
      } else {
        this.isDragging = ev.subjectEl.classList.contains(classNames.internalEventDraggable);
      }
    };
    this.handleDragStart = (ev) => {
...
function computeMutation(hit0, hit1, isFromStart, instanceRange) {
  ...
  if (isFromStart) {
    const newStart = addDeltaToRangeEdge(instanceRange.start, instanceRange.instantStartMs, delta, instantDeltaMs ?? void 0, context);
    if (newStart.instantMs != null ? newStart.instantMs < getRangeInstantEndMs(instanceRange, context.dateEnv) : newStart.marker < instanceRange.end) {
      return {
        startDelta: delta,
    ...
    const newEnd = addDeltaToRangeEdge(instanceRange.end, instanceRange.instantEndMs, delta, instantDeltaMs ?? void 0, context);
    if (newEnd.instantMs != null ? newEnd.instantMs > getRangeInstantStartMs(instanceRange, context.dateEnv) : newEnd.marker > instanceRange.start) {
      return {
        endDelta: delta,
...
// node_modules/@fullcalendar/vue3/interaction.js
...
var ExternalElementDragging = class {
  constructor(dragging, suppliedDragMeta) {
    ...
    this.handleHitUpdate = (hit, isFinal, ev) => {
      ...
      this.displayDrag(receivingContext, interaction);
      dragging2.setMirrorIsVisible(isFinal || !droppableEvent || !document.querySelector(`.${classNames.internalEventMirror}`));
      if (!isInvalid) {
        enableCursor();
      } else {
        disableCursor();
...
function computeEventForDateSpan(dateSpan, dragMeta, context) {
  ...
  let startEdge = {
    marker: start,
    instantMs: !dateSpan.allDay ? dateSpan.instantStartMs : void 0
  };
  let endEdge = dragMeta.duration ? addDurationToEdge(startEdge, dragMeta.duration, context.dateEnv) : getDefaultEventEndEdge(dateSpan.allDay, startEdge, context);
...
var ExternalDraggable = class {
  constructor(el, settings = {}) {
    ...
    this.handleDragStart = (ev) => {
      if (ev.isTouch && this.dragging.delay && ev.subjectEl.classList.contains(classNames.internalEvent)) {
...
export {
  ...
  ThirdPartyDraggable,
  interactionPlugin as default
};
//# sourceMappingURL=@fullcalendar_vue3_interaction.js.map
